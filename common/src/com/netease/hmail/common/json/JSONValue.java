...
public class JSONValue {
     ...
     *         org.json.simple.JSONArray, java.lang.Integer, java.lang.Long,
     *         java.lang.Float, java.lang.Double, java.lang.String,
     *         java.lang.Number, java.lang.Boolean, null
     * @throws Exception
     *             Parser error, then throws exception.
     */
    public static Object parse(Reader in) throws Exception {
    ...
    public static void writeJSONString(Object value, Writer out)
        ...
        if (value instanceof Date) {
            out.write(((Date) value).getTime() + "D");
            return;
        }
    ...
    public static void appendTo(Object value, StringBuilder sb) {
        if (value == null) {
            sb.append("null");
            return;
        }
        ...
        if (value instanceof Date) {
            sb.append(((Date) value).getTime() + "D");
            return;
        }
        ...
        if ((value instanceof JSONAware)) {
            ((JSONAware) value).appendTo(sb);
            return;
        }

        if (value instanceof Map) {
            JSONObject.appendTo((Map) value, sb);
            return;
        }

        if (value instanceof List) {
            JSONArray.appendTo((List) value, sb);
            return;
        }
