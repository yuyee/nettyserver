...
public abstract class BaseConfigDocument implements Configuration {
	 ...
	 * 系统工作路径系统属性名称
	 */
	public static final String PROPERTY_GIT_HOME = "GIT_HOME";

	/**
	 * 系统默认工作路径
	 */
	public static final String DEFAULT_GIT_HOME = "/home/git";
	 ...
	 * HMail系统默认工作路径
	 */
	private String gitHome = DEFAULT_GIT_HOME;
	...
	public BaseConfigDocument() {
		this.gitHome = System.getProperty(PROPERTY_GIT_HOME, DEFAULT_GIT_HOME);
	}
	 ...
	 * @return
	 */
	public static final String getSystemGitHome() {
		return System.getProperty(PROPERTY_GIT_HOME, DEFAULT_GIT_HOME);
	}
