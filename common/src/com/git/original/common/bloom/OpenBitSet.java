 ...
 * <p/>
 * <h3>Performance Results</h3> Test system: Pentium 4, Sun Java 1.5_06 -server
 * -Xbatch -Xmx64M <br/>
...
public class OpenBitSet implements Cloneable {
     ...
     * there a better way? long twosA=v0 & v1; long ones=v0^v1; long u2=ones^v2;
     * long twosB =(ones&v2)|(u2&v3); ones=u2^v3; long fours=(twosA&twosB); long
     * twos=twosA^twosB; return (pop(fours)<<2) + (pop(twos)<<1) + pop(ones); }
     */

    /** @return the number of set bits */
    public long cardinality() {
        return BitUtil.popArray(bits, 0, wlen);
    }
    ...
    public static long intersectionCount(OpenBitSet a, OpenBitSet b) {
        return BitUtil
            .popIntersect(a.bits, b.bits, 0, Math.min(a.wlen, b.wlen));
    }
    ...
    public static long unionCount(OpenBitSet a, OpenBitSet b) {
        long tot = BitUtil
            .popUnion(a.bits, b.bits, 0, Math.min(a.wlen, b.wlen));
        if (a.wlen < b.wlen) {
            tot += BitUtil.popArray(b.bits, a.wlen, b.wlen - a.wlen);
        } else if (a.wlen > b.wlen) {
            tot += BitUtil.popArray(a.bits, b.wlen, a.wlen - b.wlen);
        }
        return tot;
    }
    ...
    public static long andNotCount(OpenBitSet a, OpenBitSet b) {
        long tot = BitUtil.popAndnot(a.bits, b.bits, 0,
    ...
    public static long xorCount(OpenBitSet a, OpenBitSet b) {
        long tot = BitUtil.popXor(a.bits, b.bits, 0, Math.min(a.wlen, b.wlen));
        if (a.wlen < b.wlen) {
            tot += BitUtil.popArray(b.bits, a.wlen, b.wlen - a.wlen);
        } else if (a.wlen > b.wlen) {
            tot += BitUtil.popArray(a.bits, b.wlen, a.wlen - b.wlen);
    ...
    public Object clone() {
        try {
            ...
            obs.bits = (long[]) obs.bits.clone(); // hopefully an array clone is
                                                  // as fast(er) than
                                                  // arraycopy
            return obs;
    ...
    public byte[] getAsBytes() {
        ByteBuffer bb = ByteBuffer.wrap(new byte[bits.length << 3]);
        for (long l: bits) {
            bb.putLong(l);
        }
