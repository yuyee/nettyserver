...
import com.git.original.common.json.JSONParser;
import com.git.original.common.json.JSONValue;
import com.git.original.common.json.ParseException;
...
public final class RemoteLoggerHelper {
	...
	public static String createRemoveMailLog(int rmValue, long mailBoxId,
		...
		appendObject(REMOTE_LOG_PARAM_LOG_SERIAL_NUMBER,
				Long.toHexString(REMOTE_LOG_SERIAL_NUMBER_POOL
						.getAndIncrement()), sb);
	...
	public static String createReceiveMailLog(int result, long mailBoxId,
			Long fid, Long mid, String from, String to, String subject,
			long size, Long receivedTime, String realRcpt, String domain,
			Long mainDomainId, String transId, String deliverIp) {
		StringBuilder sb = new StringBuilder(128);
		sb.append('{'); // start record json object
	...
	public static String createDeliverStatLog(String sender, String domain,
			int rcptCount, long deliverTime, Long mainAccountId,
			Long mainDomainId, String transId, int appIp) {
		StringBuilder sb = new StringBuilder(128);
		sb.append('{'); // start record json object
