...
public class XMLConfigTester {
	...
	public static void prepare() throws Exception {
		System.setProperty(BaseConfigDocument.PROPERTY_GIT_HOME, ".");
		config.setHmailHome(".");
		config.load();
	}
	...
	public void testNumber() {
		...
		Assert.assertEquals(9876.54321, cn.getDouble("double-none", 9876.54321));
	...
	public void testMilliseconds() {
		...
		Assert.assertEquals(34L * 1000, cn.getMilliseconds("up-sec-millis", 1L));
